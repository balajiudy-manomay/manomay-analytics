  ...
  return (
    <div className="h-[calc(100vh-3.5rem)] w-full flex flex-col bg-slate-50 dark:bg-slate-950">
      <div className="flex items-center justify-between px-4 py-2 border-b border-slate-200 dark:border-slate-800 shrink-0">
        ...
        <h1 className="text-xs font-semibold text-slate-700 dark:text-slate-200">{label}</h1>
        <button
      ...
      <div className="relative flex-1 min-h-0">
        {isLoading && !error && (
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white">
          ...
          <div className="absolute inset-0 z-10 flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-6">
            <div className="max-w-md w-full bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-lg dark:shadow-2xl space-y-3">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-sm font-bold text-slate-900 dark:text-white">Couldn&apos;t load this report</h2>
              </div>
